...
class FaceDetector : Component() {
    ...
    fun loadModel(assetsManager: AssetManager,context: Context): Int = nativeLoadModel(assetsManager,context)
    ...
    @Keep
    private external fun nativeLoadModel(assetsManager: AssetManager,  activityObject:Context): Int
