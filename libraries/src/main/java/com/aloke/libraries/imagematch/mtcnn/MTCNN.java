package com.aloke.libraries.imagematch.mtcnn;
...
import com.aloke.libraries.imagematch.MyUtil;
...
public class MTCNN {
    ...
    public MTCNN(Context context) throws IOException, PackageManager.NameNotFoundException {
        Interpreter.Options options = new Interpreter.Options();
        options.setNumThreads(4);
        pInterpreter = new Interpreter(MyUtil.loadModelFile_only(context, MODEL_FILE_PNET), options);
        rInterpreter = new Interpreter(MyUtil.loadModelFile_only(context, MODEL_FILE_RNET), options);
        oInterpreter = new Interpreter(MyUtil.loadModelFile_only(context, MODEL_FILE_ONET), options);
    }
