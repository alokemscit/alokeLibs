...
public class MyUtil {
    ...
    public static MappedByteBuffer loadModelFile_only( Context context, String modelPath) throws IOException {

        //MyLibraryClass myLibrary = new MyLibraryClass();
        //AssetManager assetManager=myLibrary.accessAssets(context, "com.aloke.libraries");
        LibraryAssetsManager libraryAssetsManager = new LibraryAssetsManager(context);
        AssetManager assetManager = libraryAssetsManager.getAssets();
       // Resources resources = context.getPackageManager().getResourcesForApplication("com.aloke.libraries");
        // Access the AssetManager from the Resources object
 ...
 class LibraryAssetsManager {
    private Context context;

    public LibraryAssetsManager(Context context) {
