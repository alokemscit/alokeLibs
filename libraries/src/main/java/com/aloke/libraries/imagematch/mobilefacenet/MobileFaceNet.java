package com.aloke.libraries.imagematch.mobilefacenet;
...
public class MobileFaceNet {
    ...
    public MobileFaceNet(Context context) throws IOException, PackageManager.NameNotFoundException {
        Interpreter.Options options = new Interpreter.Options();
        options.setNumThreads(4);
        interpreter = new Interpreter(MyUtil.loadModelFile_only(context, MODEL_FILE), options);
    }
