...
public class RectView : View {
    ...
    override fun onDraw(canvas: Canvas?) {
       ...
       // paint.style = Paint.Style.STROKE
        ...
        val text =confidence// decimalFormat.format(confidence)
